...
const errorPage = () => {
      return( 
        <div className={style.errorContainer}>
          <h1 className={style.errorTitle}>PÁGINA DE <b style={{color:'#e2ba5e'}}>ERROR</b></h1>
    
          <div className={style.svgContainer}>
            <h2 className={style.leftH2}>4</h2>
            <svg
              width="8em"
              height="8em"
